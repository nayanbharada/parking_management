...
class Premises(TimeStampedModel, ActivatorModel):
    premise_user = models.ForeignKey(
        UserMaster, on_delete=models.CASCADE, related_name="premise_users"
    )
...
class Slot(TimeStampedModel, ActivatorModel):
    ...
    premise_slot = models.ForeignKey(
        Premises, on_delete=models.CASCADE, related_name="premises_slots"
    )
...
class BookParking(TimeStampedModel, ActivatorModel):
    slot_book = models.ForeignKey(
        Slot, on_delete=models.CASCADE, related_name="slot_books"
    )
    user = models.ForeignKey(
        UserMaster, on_delete=models.CASCADE, related_name="user_bookings"
    )
